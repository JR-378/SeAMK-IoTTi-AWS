JSON-To-PC contains the code for Arduino Mega. Open it with Arduino IDE.
...
Driver.zip contains the driver for a Chinese copy of Arduino Mega, as the official Arduino USB drivers won't work with it.
